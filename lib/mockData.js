...
export const VERIFIED_VENDORS = [
  ...
  {
    id: "ven_bharat_06",
    name: "Bharat Electro Hub",
    legalName: "Bharat Electro Hub Wholesale Pvt Ltd",
    trustScore: 97,
    slaHours: 24,
    currentBid: 835,
    rating: 4.9,
    ...
    categories: ["Electronics", "Components", "Industrial Supplies"],
    minLeadTimeHours: 24,
    baseMargin: 0.11,
    gstin: "27AAACB8901F1ZX",
    contactEmail: "corporate@bharatelectrohub.in",
    contactPhone: "+91 22 6655 4400"
  },
  {
    id: "ven_shanti_07",
    name: "Shanti Enterprise Components",
    legalName: "Shanti Enterprise Industrial Components LLP",
    trustScore: 93,
    slaHours: 48,
    currentBid: 855,
    rating: 4.7,
    ...
    categories: ["Peripherals", "OEM Manufacturing", "Hardware"],
    minLeadTimeHours: 48,
    baseMargin: 0.13,
    gstin: "24AAACS9981K1Z3",
    contactEmail: "b2b@shanticomponents.com",
    contactPhone: "+91 79 2658 1122"
  },
  {
    id: "ven_prime_08",
    name: "Prime Commercial Hub",
    legalName: "Prime Commercial Wholesale Distribution Corp",
    trustScore: 95,
    slaHours: 36,
    currentBid: 845,
    rating: 4.8,
    ...
    isoCertified: true,
    msmeRegistered: false,
    pastFulfillmentRate: 98.7,
    categories: ["Office Infrastructure", "IT Hardware", "Cabling"],
    minLeadTimeHours: 36,
    baseMargin: 0.14,
    gstin: "36AABCP4410H1ZQ",
    contactEmail: "procure@primecommercialhub.org",
    contactPhone: "+91 40 4499 8811"
  },
  {
    id: "ven_zen_09",
    name: "Zen Ergonomics Ltd",
    legalName: "Zen Ergonomics & Workplace Systems Ltd",
    trustScore: 99,
    slaHours: 24,
    currentBid: 825,
    rating: 4.95,
    ...
    isoCertified: true,
    msmeRegistered: true,
    pastFulfillmentRate: 99.8,
    categories: ["Ergonomics", "Specialty Seating", "Workstations"],
    minLeadTimeHours: 24,
    baseMargin: 0.10,
    gstin: "07AAACZ1122J1ZM",
    contactEmail: "institutional@zenergonomics.in",
    contactPhone: "+91 11 4100 2233"
  },
  {
    id: "ven_apex_10",
    name: "Apex Industrial Tech",
    legalName: "Apex Industrial Technology Solutions Pvt Ltd",
    trustScore: 94,
    slaHours: 48,
    currentBid: 860,
    rating: 4.75,
    ...
    categories: ["Industrial Electronics", "Bulk Sourcing", "Peripherals"],
    minLeadTimeHours: 48,
    baseMargin: 0.15,
    gstin: "19AAACA4490L1ZT",
    contactEmail: "sales@apexindustrialtech.com",
    contactPhone: "+91 33 2288 9900"
  }
];
